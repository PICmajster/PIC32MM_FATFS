...
#define CS_LOW()	PORTBbits.RB3 = 0	/* MMC CS = L */
#define CS_HIGH()	PORTBbits.RB3 = 1	/* MMC CS = H */
#define MMC_CD		(1)//(!_RB11)	/* Card detected   (yes:true, no:false, default:true) */
#define MMC_WP		(0)//(_RB10)	/* Write protected (yes:true, no:false, default:false) */
